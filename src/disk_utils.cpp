                              ...
                              const uint32_t Lf)
{
    ...
    if (full_index_ram < ram_budget * 1024 * 1024 * 1024)
    {
        ...
        diskann::IndexWriteParameters paras = diskann::IndexWriteParametersBuilder(L, L, R, 1, 2, 3, 4, 0.0, 3)
    ...
    for (int p = 0; p < num_parts; p++)
    {
        ...
        diskann::IndexWriteParameters low_degree_params = diskann::IndexWriteParametersBuilder(L, L, 2 * R / 3, 1, 2, 3, 4, 0.0, 3)
                                                              .with_filter_list_size(Lf)
