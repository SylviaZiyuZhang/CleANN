...
template <class DT> void DynamicMemoryIndex<DT>::consolidate_deletes_reverse_edge_gathered()
{
    _index.consolidate_deletes_reverse_edge_gathered(_write_parameters);
}
