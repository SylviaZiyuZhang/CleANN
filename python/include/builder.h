...
void build_disk_index(diskann::Metric metric, const std::string &data_file_path, const std::string &index_prefix_path,
                      ...
                      uint32_t bridge_start_lb, uint32_t bridge_start_hb, uint32_t bridge_end_lb, uint32_t bridge_end_hb, float bridge_prob, double final_index_ram_limit,
...
void build_memory_index(diskann::Metric metric, const std::string &vector_bin_path,
                           ...
                           float alpha, uint32_t bridge_start_lb, uint32_t bridge_start_hb, uint32_t bridge_end_lb, uint32_t bridge_end_hb, float bridge_prob,
